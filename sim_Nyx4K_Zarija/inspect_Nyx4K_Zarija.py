...
def read_h5bigCube(inpF,dataN,verb=1):
    ...
    #dataN=/%s"%name
    if verb>0: print('read %s ...'%dataN, 'shape=',f[dataN].shape,f[dataN].dtype)
    data = f[dataN][:]
    f.close()
...
if __name__ == '__main__':
    dataPath='/pscratch/sd/z/zarija/MLHydro/'
    
    inpF=os.path.join(dataPath,"L80_N512_z3_s1.hdf5")  # LR, z=3
    #inpF=os.path.join(dataPath,"L80_N4096_z3_s1.hdf5")  # HR, z=3
